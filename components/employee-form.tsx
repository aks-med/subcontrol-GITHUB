...
export function EmployeeForm({ isOpen, onClose, onSuccess, employee, companyId, titulares = [], allowDependentes = true }: EmployeeFormProps) {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <button type="button" onClick={onClose} className="btn-secondary flex-1 order-2 sm:order-1">
              Cancelar
            </button>
            <button type="submit" disabled={loading} className="btn-primary flex-1 order-1 sm:order-2">
